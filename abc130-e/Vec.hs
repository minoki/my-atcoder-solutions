...
main = do
  ...
  let v0 :: U.Vector N
      v0 = U.replicate (m + 1) 1
      step :: U.Vector N -> Int -> U.Vector N
      step v !s = U.scanl' (\c (t,a,b) -> if s == t then b + c else b + c - a) 1 $ U.zip3 ts v (U.tail v)
  print $ U.last $ U.foldl' step v0 ss
